...
const nodeDefs = [
  ...
  { id: 'O', letter: 'O', lampType: 'square', orientation: 'horizontal', labelPosition: 'above', x: 12, y: 10 },
  { id: 'M', letter: 'M', lampType: 'square', orientation: 'horizontal', labelPosition: 'above', x: 25, y: 10, dot: 'G', dash: 'O' },
  { id: 'T', letter: 'T', lampType: 'square', orientation: 'horizontal', labelPosition: 'above', x: 38, y: 10, dot: 'N', dash: 'M' },
  { id: 'E', letter: 'E', lampType: 'circle', labelPosition: 'above', x: 62, y: 10, dot: 'I', dash: 'A' },
  { id: 'I', letter: 'I', lampType: 'circle', labelPosition: 'above', x: 74, y: 10, dot: 'S', dash: 'U' },
  { id: 'S', letter: 'S', lampType: 'circle', labelPosition: 'above', x: 85, y: 10, dot: 'H', dash: 'V' },
